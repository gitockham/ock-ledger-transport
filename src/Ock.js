...
export default class Ock {
   ...
   * @example
   * ock.getAddress("44'/111'/0'/0/0").then(o => o.address)
   */
  getAddress(
    path: string
  ): Promise<{
   ...
   * @example
   ock.signTransaction("44'/111'/0'/0/0", "").then(result => ...)
   */
  signTransaction(
    path: string,
    rawTxHex: string
